...
- [[investigating-and-developing-ideas|Investigating and developing ideas]] — research, primary and contextual sources, critical understanding of artists' methods (AO1 territory)
- [[refining-through-experimentation|Refining through experimentation with media]] — selecting and trying materials, techniques, processes (AO2 territory)
- [[recording-and-reflecting|Recording observations and insights]] — sketchbook practice, annotation, reflective process logs (AO3 territory)
- [[presenting-personal-response|Presenting a personal response]] — final outcomes, realising intentions, controlling visual language (AO4 territory)
- [[critical-and-contextual-understanding|Critical and contextual understanding]] — art history, artists' methods, cultural context, ethics of representation (woven through AO1 and AO4)
- [[material-practice|Material practice]] — actual making in the chosen medium (drawing, painting, photography, textiles, 3D, digital, mixed)

## Cross-cutting capability

- [[portfolio-as-evidence|Portfolio practice as evidence]] — the meta-skill of curating one's own learning visibly over time
...
KS4 Art and Design connects most directly to [[../../../01-cornerstones/creativity|Creativity]] (●●●) and [[../../../01-cornerstones/reflection|Reflection]] (●●●). The relational dimension — texts chosen collaboratively, work shared with the practitioner, exhibition with family — also makes it a route into [[../../../01-cornerstones/connection|Connection]].
